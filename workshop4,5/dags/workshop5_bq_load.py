#Upload to BigQuery
'''
 มีข้อมูลใน GCS และมี Airflow แล้ว แล้วจะทํายังไงให้
 ข้อมูลเข้ามาเก็บใน Data Warehouse แบบอัตโนมัติ?
 1. สร้าง Dataset บน BigQuery
 2. Import ข้อมูลด้วยวิธีต่าง ๆ
    a. Import ผ่าน Cloud Console (Web UI) บน
    web browser
    b. Import ผ่าน bq command ด้วย
    BashOperator บน Airflow
    c. Import ผ่าน GCSToBigQeryOperator 
    บนAirflow
...
def workshop5_bash():
    ...
    # workshop.conversion_rate \
    # gs://us-central1-composer3-a6f99094-bucket/data/output.parquet
    ...
    t4 = BashOperator(
        ...
        bash_command="bq load \
                    ...
                    gs://us-central1-composer3-a6f99094-bucket/data/workshop4_output.parquet"
    )
